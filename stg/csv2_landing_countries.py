...
DB_URL = db_conn
DB_TABLE = 'public.countries'  # Target table in the stg schema

# Source CSV file (update this path as per your setup)
SOURCE_FILE = '/opt/airflow/dags/input/20180508/20180508.countries.csv'  # Path to the uploaded CSV file
...
def start_spark_session(SOURCE_FILE, DB_URL, DB_TABLE):
    ...
    spark = SparkSession.builder \
                .appName("spark_insert_countries") \
...
with DAG(
    ...
    task_csv2stg = PythonOperator(
        task_id='spark_csv2stg_countries',
