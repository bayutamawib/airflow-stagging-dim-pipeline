...
DB_URL = db_conn
DB_TABLE = 'public.cities'  # Target table in the stg schema

# Source CSV file (update this path as per your setup)
SOURCE_FILE = '/opt/airflow/dags/input/20180508/20180508.cities.csv'  # Path to the uploaded CSV file
